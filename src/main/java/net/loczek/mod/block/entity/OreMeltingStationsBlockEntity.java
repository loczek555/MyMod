...
public class OreMeltingStationsBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    public OreMeltingStationsBlockEntity(BlockPos pos, BlockState state) {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            ...
            public int get(int index) {
                return switch (index) {
                    case 0 -> OreMeltingStationsBlockEntity.this.progress;
                    case 1 -> OreMeltingStationsBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> OreMeltingStationsBlockEntity.this.progress = value;
                    case 1 -> OreMeltingStationsBlockEntity.this.maxProgress = value;
                }
            }
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        nbt.putInt("ore_melting_station.progress", progress);
    }
    ...
    public void readNbt(NbtCompound nbt) {
        ...
        progress = nbt.getInt("ore_melting_station.progress");
    }

    @Override
    public Text getDisplayName() {
        return Text.translatable("ore_melting_station_block");
    }
    ...
    private Optional<RecipeEntry<OreMelterRecipe>> getCurrentRecipe() {
        SimpleInventory inv = new SimpleInventory(this.size());
        for(int i = 0; i < this.size(); i++) {
            inv.setStack(i, this.getStack(i));
        }

        return getWorld().getRecipeManager().getFirstMatch(OreMelterRecipe.Type.INSTANCE, inv, getWorld());
    }
