...
public class OreMeltingCategory implements DisplayCategory {
    public static final Identifier TEXTURE =
            new Identifier(CustomMod.MOD_ID, "textures/gui/ore_melter_station_gui.png");
    public static final CategoryIdentifier<OreMeltingDisplay> ORE_MELTER =
            CategoryIdentifier.of(CustomMod.MOD_ID, "ore_melter");
    ...
    public Text getTitle() {
        return Text.translatable("ore_melter_station");
    }
